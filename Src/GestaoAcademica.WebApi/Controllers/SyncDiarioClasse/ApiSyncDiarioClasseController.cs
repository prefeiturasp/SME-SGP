...
namespace GestaoAcademica.WebApi.Controllers.SyncDiarioClasse
{
    ...
    public class ApiSyncDiarioClasseController : ApiController
    {
        /// <summary>
        /// Recebe e sincroniza todas as informações necessárias referentes a uma aula.
        /// </summary>
        ...
        public SincronizacaoDiarioClasseSaidaDTO Post([FromUri] SincronizacaoDiarioClasseEntradaDTO filtroEntrada)
        {
            try
            {
                ...
                return ApiBO.SincronizaDiarioClasse(filtroEntrada, DCL_ProtocoloBO.eTipo.Aula);
            }
            catch
            {
                return null;
