...
namespace GestaoAcademica.WebApi.Controllers.SyncDiarioClasse
{
    ...
    public class ApiListagemTurmasController : ApiController
    {
        /// <summary>
        ...
        public BuscaTurmasSaidaDTO GetAll([FromUri] BuscaTurmasEntradaDTO filtroEntrada)
        {
            try
            {
                return ApiBO.BuscaTurmas(filtroEntrada);
            }
            catch
            {
                return null;
