...
namespace GestaoAcademica.WebApi.Controllers
{
    ...
    public class ApiListagemTurnosController : ApiController
    {
        /// <summary>
        ...
        /// <returns></returns>
        public BuscaTurnosSaidaDTO GetAll([FromUri] BuscaTurnosEntradaDTO filtroEntrada)
        {
            try
            {
                return ApiBO.BuscaTurnos(filtroEntrada);
            }
            catch
            {
                return null;
