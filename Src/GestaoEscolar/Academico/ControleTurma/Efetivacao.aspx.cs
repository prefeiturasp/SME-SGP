...
{
    public partial class Efetivacao : MotherPageLogadoCompressedViewState
    {
        #region Propriedades
                ...
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        UCNavegacaoTelaPeriodo.CarregarPeriodos(VS_ltPermissaoFrequencia, VS_ltPermissaoEfetivacao,
                                                                ...
                                                                VS_EntitiesControleTurma.turmaDisciplina.tud_tipo, UCControleTurma1.VS_tdt_posicao, turma.tur_id, VS_EntitiesControleTurma.turmaDisciplina.tud_id);
