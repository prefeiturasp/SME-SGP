...
{
    public partial class EnsinoFundamental : MotherPageLogado
    {
        #region Propriedades
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "TrocaClassesTab1", "$(document).ready(function() { $('.btnTabs').parent().removeClass('ui-tabs-selected ui-state-active'); $('.btnTab1').parent().addClass('ui-tabs-selected ui-state-active'); $('.btnTab1').removeAttr('href'); });", true);
            ...
            if (!IsPostBack)
            {
                ...
                UCEnsinoFundamental.VS_alu_id = VS_alu_id;
                UCEnsinoFundamental.CarregarAluno();
            }

            UCEnsinoFundamental.clickVisualizar += VisualizarHistorico_Click;
            UCEnsinoFundamental.clickVoltar += Voltar_Click;
        }
