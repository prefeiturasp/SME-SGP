...
{
    public partial class InformacoesComplementares : MotherPageLogado
    {
        #region Propriedades
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "TrocaClassesTab3", "$(document).ready(function() { $('.btnTabs').parent().removeClass('ui-tabs-selected ui-state-active'); $('.btnTab3').parent().addClass('ui-tabs-selected ui-state-active'); $('.btnTab3').removeAttr('href'); });", true);
            ...
            if (!IsPostBack)
            {
                ...
                UCInformacoesComplementares.Carregar(VS_alu_id);
            }

            UCInformacoesComplementares.clickVisualizar += VisualizarHistorico_Click;
            UCInformacoesComplementares.clickVoltar += Voltar_Click;
        }
        ...
        private void VisualizarHistorico_Click()
        {
            ...
            catch (Exception ex)
            {
                ...
                UCInformacoesComplementares.message = UtilBO.GetErroMessage((string)GetGlobalResourceObject("HistoricoEscolar", "HistoricoEscolar.ErroCarregarHistoricoAluno"),
