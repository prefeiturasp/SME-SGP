...
{
    public partial class UCAgendamento : MotherUserControl
    {
        #region Propriedades
        ...
        /// <summary>
        /// Propriedade em ViewState que armazena valor da página de busca
        /// </summary>
        public string VS_paginaBusca
        {
            get
            {
                if (ViewState["VS_paginaBusca"] != null)
                {
                    return ViewState["VS_paginaBusca"].ToString();
                }
                return "";
            }
            set
            {
                ViewState["VS_paginaBusca"] = value;
            }
        }

        private DataTable dtDadosRepeater;

        public bool bntSalvarVisible
        {
            set
            {
                bntSalvar.Visible = value;
            }
        }
            ...
            try
            {
                if (ACA_SondagemAgendamentoBO.Salvar(VS_snd_id, VS_ListaAgendamento, VS_ListaAgendamentoPeriodo))
                {
                    ...
                    else
                    {
                        ...
                        Response.Redirect(__SessionWEB._AreaAtual._Diretorio + VS_paginaBusca, false);
