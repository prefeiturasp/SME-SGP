<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoletimAlunos.aspx.cs" Inherits="GestaoEscolar.WebControls.BoletimCompletoAluno.BoletimAlunos" %>
...
<body style="background: none; width: 99%">
        ...
        <div id="divBoletinsAlunos">
            <div ng-app="app">
                <div ng-controller="BoletimController" ng-cloak>
                    ...
                    <div class="divBoletinsAnteriores notprint" ng-if="listBoletins.length > 0 || mensagemAlerta" style="display: inline-block; width: 100%;">
                    ...
                    <div style="page-break-after: always" ng-repeat="boletim in listBoletins">
