...
{
    public partial class UCDadosBoletim : MotherUserControl
    {
        #region Propriedades
        ...
        protected void rptDisciplinas_ItemDataBound(Object Sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //Mescla as linhas da freq. final para os componentes
                if (QtComponenteRegencia > 0)
                {
                    if (!ControleMesclaDisciplina && ExibeCompensacaoAusencia)
                    {
                        ...
                        tdTotFrequenciaAjustada.RowSpan = QtComponentes;
                        tdTotFrequenciaAjustada.Visible = true;

                        ControleMesclaDisciplina = true;
                    }
