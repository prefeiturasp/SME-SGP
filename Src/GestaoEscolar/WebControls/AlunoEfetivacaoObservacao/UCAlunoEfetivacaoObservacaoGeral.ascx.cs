...
namespace GestaoEscolar.WebControls.AlunoEfetivacaoObservacao
{
    public partial class UCAlunoEfetivacaoObservacaoGeral : MotherUserControl
    {
        ...
        protected void rptDisciplinas_ItemDataBound(Object Sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdNotaFinal, true, DataBinder.Eval(e.Item.DataItem, "MediaFinal").ToString(), false, false, false, false,
                    ...
                    AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdFrequenciaAjustada, false, "", false, false, false, false,
                    ...
                    AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdAusenciasCompensadas, false, "", false, false, false, false,
                                    eSituacaoMatriculaTurmaDisicplina.Ativo, Convert.ToBoolean(DataBinder.Eval(e.Item.DataItem, "esconderPendenciaFinal").ToString()) || !fechamentoFinalAberto);

                    HtmlTableCell tdFaltasExternas = (HtmlTableCell)e.Item.FindControl("tdTotFaltasExternas");
                    AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdFaltasExternas, false, "", false, false, false, false,
                                    eSituacaoMatriculaTurmaDisicplina.Ativo, Convert.ToBoolean(DataBinder.Eval(e.Item.DataItem, "esconderPendenciaFinal").ToString()) || !fechamentoFinalAberto);
                }
            }
            catch (Exception ex)
            ...
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    if (ddlParecerFinal != null)
                    {
                        ...
                        AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdParecerFinal, lancaParecerFinal, valor, false, false, false, false, eSituacaoMatriculaTurmaDisicplina.Ativo,
                    ...
                    HtmlTableCell tdFrequenciaAjustada = (HtmlTableCell)e.Item.FindControl("tdTotFrequenciaAjustada");
                    AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdFrequenciaAjustada, false, "", false, false, false, false, eSituacaoMatriculaTurmaDisicplina.Ativo,
        ...
        protected void rptNotasDisciplina_ItemDataBound(Object Sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    AlterarCorFundo(tpc_id, tdConceito, false, nota, false, existeAulaBimestre, false, false, SituacaoDisciplina, esconderPendencia, -1, -1,
                    ...
                    AlterarCorFundo(tpc_id, tdNota, true, nota, false, existeAulaBimestre, false, false, SituacaoDisciplina, esconderPendencia, -1, -1,
                                    VS_ConfiguracaoServicoPendencia.Any(p => (p.tne_id == tne_id || p.tne_id <= 0) && (p.tme_id == tme_id || p.tme_id <= 0) && (p.tur_tipo == tur_tipo || p.tur_tipo <= 0) && p.csp_semNota));

                    HtmlTableCell tdNotaPosConselho = (HtmlTableCell)e.Item.FindControl("tdNotaPosConselho");
                    AlterarCorFundo(tpc_id, tdNotaPosConselho, true, nota, false, existeAulaBimestre, false, false, SituacaoDisciplina, esconderPendencia, -1, -1,
                                    VS_ConfiguracaoServicoPendencia.Any(p => (p.tne_id == tne_id || p.tne_id <= 0) && (p.tme_id == tme_id || p.tme_id <= 0) && (p.tur_tipo == tur_tipo || p.tur_tipo <= 0) && p.csp_semNota));
                    ...
                    if (recuperacao)
                    {
                        ...
                        AlterarCorFundo(tpc_id, tdQtdFaltas, false, nota, validarQtdAulas, existeAulaBimestre, false, false, SituacaoDisciplina, esconderPendencia, tud_id, cal_id,
                        ...
                        AlterarCorFundo(tpc_id, tdQtdFaltas, false, nota, false, existeAulaBimestre, true, possuiAnotacaoRP, SituacaoDisciplina, esconderPendencia, tud_id, cal_id,
                                      cspRelatorio.HasFlag(eConfiguracaoServicoPendenciaSemRelatorioAtendimento.RP));
                    }
                    else
                    {
                        AlterarCorFundo(tpc_id, tdQtdFaltas, false, nota, validarQtdAulas, existeAulaBimestre, false, false, SituacaoDisciplina, esconderPendencia, -1, -1,
                                        VS_ConfiguracaoServicoPendencia.Any(p => (p.tne_id == tne_id || p.tne_id <= 0) && (p.tme_id == tme_id || p.tme_id <= 0) && (p.tur_tipo == tur_tipo || p.tur_tipo <= 0) && p.csp_disciplinaSemAula));
                    }
                }
            }
            ...
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    if (ddlParecerFinal != null)
                    {
                        ...
                        HtmlTableCell tdParecerFinal = (HtmlTableCell)e.Item.FindControl("tdParecerFinal");
                        AlterarCorFundo(VS_tpc_idUltimoPeriodo, tdParecerFinal, true, valor, false, false, false, false, eSituacaoMatriculaTurmaDisicplina.Ativo,
                                        Convert.ToBoolean(DataBinder.Eval(e.Item.DataItem, "esconderPendenciaFinal").ToString()) || !fechamentoFinalAberto
        ...
        private void AlterarCorFundo(int tpc_id, HtmlTableCell td, bool validarNota, string nota, bool validarFreq, bool existeAulaBimestre, bool validarAnotacaoRP, bool possuiAnotacaoRP
