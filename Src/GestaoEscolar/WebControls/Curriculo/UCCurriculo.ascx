...
<asp:UpdatePanel runat="server" ID="updCadastro" UpdateMode="Always">
    <ContentTemplate>
        ...
        <fieldset class="fieldset-curriculo">
            <legend>
                <asp:Literal runat="server" ID="litLegend" Text="" /></legend>
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources:Academico, Curriculo.Cadastro.grvGeral.ColunaTopico %>">
                                ...
                                <EditItemTemplate>
                                    <asp:Panel ID="pnlItem" runat="server">
                                        ...
                                        <CKEditor:CKEditorControl ID="txtTitulo" BasePath="/includes/ckeditor/" runat="server" Text='<%# Bind("crc_titulo") %>'></CKEditor:CKEditorControl>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:Academico, Curriculo.Cadastro.grvEixo.ColunaEixo %>">
                                            ...
                                            <EditItemTemplate>
                                                <asp:Panel ID="pnlItem" runat="server">
                                                    ...
                                                    <%-- <asp:TextBox ID="txtDescricao" runat="server" Text='<%# Bind("cro_descricao") %>' TextMode="MultiLine" Rows="4"></asp:TextBox>--%>
                                                    <CKEditor:CKEditorControl ID="txtDescricao" BasePath="/includes/ckeditor/" runat="server" Text='<%# Bind("cro_descricao") %>'></CKEditor:CKEditorControl>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="<%$ Resources:Academico, Curriculo.Cadastro.grvGeral.ColunaEditar %>" HeaderStyle-CssClass="center" HeaderStyle-Width="50">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="btnEditar" runat="server" CommandName="Edit" SkinID="btEditar" ToolTip="<%$ Resources:Academico, Curriculo.Cadastro.btnEditar.ToolTip %>" CausesValidation="false" />
                                                                    <div class="btnsEdicaoObjetivo">
                                                                        <asp:ImageButton ID="btnSalvar" runat="server" CommandName="Update" SkinID="btConfirmar" ToolTip="<%$ Resources:Academico, Curriculo.Cadastro.btnSalvar.ToolTip %>" ValidationGroup="eixo" Visible="false" /><asp:ImageButton ID="btnCancelarEdicao" runat="server" CommandName="Cancel" SkinID="btCancelar" ToolTip="<%$ Resources:Academico, Curriculo.Cadastro.btnCancelarEdicao.ToolTip %>" CausesValidation="false" Visible="false" />
                                                                    </div>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
