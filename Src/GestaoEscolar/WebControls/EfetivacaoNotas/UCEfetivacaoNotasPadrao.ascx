            ...
            <div style="border-style: solid; border-width: thin;">
                <table id="tbLegenda" runat="server" style="border-collapse: separate !important; border-spacing: 2px !important;">
                    ...
                    <tr runat="server" id="lnObrigatorio">
                        <td style="border-style: solid; border-width: thin; width: 25px; height: 15px;"></td>
                        <td><asp:Literal runat="server" ID="litObrigPreenchimentoRelAval" Text="<%$ Resources:Mensagens, MSG_ALUNO_OBRIG_PREENCHIMENTO_REL_AVAL %>"></asp:Literal>
                        </td>
                    </tr>
                    <tr runat="server" id="lnAlunoNaoAvaliado">
                        <td style="border-style: solid; border-width: thin; width: 25px; height: 15px;"></td>
                        <td><asp:Literal runat="server" ID="litNaoAvaliado" Text="<%$ Resources:Mensagens, MSG_ALUNO_NAO_AVALIADO %>"></asp:Literal>
                        </td>
                    </tr>
