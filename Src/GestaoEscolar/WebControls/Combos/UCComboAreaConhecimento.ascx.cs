...
{
    public partial class UCComboAreaConhecimento : MotherUserControl
    {
        #region PROPRIEDADES
        ...
        public string Titulo
        {
            set
            {
                ...
                cpvCombo.ErrorMessage = value.Replace('*', ' ') + " é obrigatória.";
            }
        }

        /// <summary>
        /// Adciona e remove a mensagem "Selecione uma área de conhecimento" do dropdownlist.  
        /// </summary>
        public bool MostrarMessageSelecione
        {
            set
            {
                if ((value) && (ddlCombo.Items.FindByValue("-1") == null))
                    ddlCombo.Items.Insert(0, new ListItem("-- Selecione uma área de conhecimento --", "-1", true));
