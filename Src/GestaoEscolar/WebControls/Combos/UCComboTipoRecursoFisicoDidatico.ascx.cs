...
public partial class WebControls_Combos_UCCadastroTipoRecursoFisicoDidatico : MotherUserControl
{
    #region PROPRIEDADES
    ...
    /// <summary>
    /// Define a visibilidade do titulo do combo 
    /// </summary>
    ...
    /// </summary>
    public void CarregarRecursoFisicoDidatico()
    {
        ddlCombo.Items.Clear();
        odsDados.SelectParameters.Clear();

        ddlCombo.Items.Insert(0, new ListItem("-- Selecione um recurso físico didático --", "-1", true));
        ddlCombo.DataBind();
    }
