...
public partial class WebControls_Combos_UCComboTipoMovimentacaoMatriculaCombo : MotherUserControl
{
    #region PROPRIEDADES
    ...
    /// </summary>
    public void CarregarTipoMovimentacao()
    {
        ...
        ddlCombo.Items.Insert(0, new ListItem("-- Selecione um tipo de movimentação --", "-1", true));
        ddlCombo.DataBind();
    }
