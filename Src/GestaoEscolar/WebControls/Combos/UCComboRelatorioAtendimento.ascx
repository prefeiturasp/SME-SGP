...
<asp:Label ID="lblTitulo" runat="server" Text="Relatório" AssociatedControlID="ddlCombo"></asp:Label>
...
<asp:CompareValidator ID="cpvCombo" runat="server" ErrorMessage="Relatório é obrigatório."
