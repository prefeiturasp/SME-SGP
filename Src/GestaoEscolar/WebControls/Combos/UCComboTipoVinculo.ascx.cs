...
public partial class WebControls_Combos_UCComboTipoVinculo : MotherUserControl
{
    #region Delegates
    ...
    /// </summary>
    public void CarregarTipoVinculo()
    {
        ...
        ddlCombo.Items.Insert(0, new ListItem("-- Selecione um tipo de vínculo --", "-1", true));
        ddlCombo.DataBind();
    }
