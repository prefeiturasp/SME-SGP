...
{
    public partial class UCCTipoEvento : MotherUserControl
    {
        #region Constantes
        ...
        private void CarregarMensagemSelecione()
        {
            if (MostrarMensagemSelecione && (ddlCombo.Items.FindByValue(valorSelecione) == null))
                ddlCombo.Items.Insert(0, new ListItem(GetGlobalResourceObject("UserControl", "UCCTipoEvento.ddlCombo.Selecione").ToString(), valorSelecione, true));
