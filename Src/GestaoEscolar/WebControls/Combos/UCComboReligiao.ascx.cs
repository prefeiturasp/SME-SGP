...
public partial class WebControls_Combos_UCComboReligiao : MotherUserControl
{
    #region DELEGATES
    ...
    /// </summary>
    public void CarregarReligiao()
    {
        ddlCombo.Items.Clear();
        odsDados.SelectParameters.Clear();

        ddlCombo.Items.Insert(0, new ListItem("-- Selecione uma religião --", "-1", true));
        ddlCombo.DataBind();
    }
