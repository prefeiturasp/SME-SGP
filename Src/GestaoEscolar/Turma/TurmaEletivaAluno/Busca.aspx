<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Turma.TurmaEletivaAluno.Busca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlTurma" runat="server" GroupingText="Consulta de turmas de eletivas">
            ...
            <asp:UpdatePanel ID="upnPesquisa" runat="server">
                <ContentTemplate>
                    ...
                    <uc9:UCComboCurriculoPeriodo ID="uccCurriculoPeriodo" runat="server" _MostrarMessageSelecione="true"
                        PermiteEditar="false" />
                    <uc4:UCComboCalendario ID="uccCalendario" runat="server" MostrarMensagemSelecione="true" />
    ...
    <fieldset id="fdsResultado" runat="server" visible="false">
        ...
        <asp:GridView ID="gvTurma" runat="server" AutoGenerateColumns="False" DataSourceID="odsTurmaEletiva"
            AllowPaging="True" EmptyDataText="A pesquisa não encontrou resultados." DataKeyNames="tur_id,tur_situacao"
            OnDataBound="gvTurmaEletiva_DataBound" PageSize="10" AllowSorting="True">
            <Columns>
                <asp:TemplateField HeaderText="Código da turma" SortExpression="tur_codigo">
                    <ItemTemplate>
                        <asp:LinkButton ID="_btnAlterar" CausesValidation="false" runat="server" CommandName="Edit"
                            Text='<%# Bind("tur_codigo") %>' PostBackUrl="~/Turma/TurmaEletivaAluno/Cadastro.aspx"
                ...
                <asp:BoundField DataField="tud_nome" HeaderText="<%$ Resources:Turma, TurmaEletivaAluno.Busca.gvTurma.Coluna6 %>" SortExpression="tud_nome" />
        ...
        <asp:ObjectDataSource ID="odsTurmaEletiva" runat="server" DataObjectTypeName="MSTech.GestaoEscolar.Entities.TUR_Turma"
            TypeName="MSTech.GestaoEscolar.BLL.TUR_TurmaBO" DeleteMethod="Delete" SelectMethod="GetSelectBy_Pesquisa_TurmasEletivasAluno">
