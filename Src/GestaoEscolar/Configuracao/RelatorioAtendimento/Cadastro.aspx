                ...
                <asp:UpdatePanel ID="updQuestionario" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <div runat="server" id="divAdicionarQuestionario" visible="false">
                                <fieldset>
                                    ...
                                    <div class="right">
                                        <asp:Button runat="server" ID="btnAdicionarQuestionario" Text="<%$ Resources:Configuracao, RelatorioAtendimento.Cadastro.btnAdicionarQuestionario.Text %>" ValidationGroup="vgQuestionario"
                                            OnClick="btnAdicionarQuestionario_Click" />
                                        <asp:Button runat="server" ID="btnCacelarQuestionario" Text="<%$ Resources:Configuracao, RelatorioAtendimento.Cadastro.btnCacelarQuestionario.Text %>" CausesValidation="false"
                                            OnClick="btnCacelarQuestionario_Click" />
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div class="right">
                                <asp:Button runat="server" ID="btnNovoQuestionario" Text="<%$ Resources:Configuracao, RelatorioAtendimento.Cadastro.btnNovoQuestionario.Text %>" ValidationGroup="vgQuestionario"
