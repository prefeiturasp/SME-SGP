...
namespace GestaoEscolar.Relatorios.RelatoriosCP.DadosAlunosBaixaFrequencia
{
    public partial class Busca : MotherPageLogado
    {
        ...
        protected void SalvaBusca()
        {
            ...
            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.DadosAlunosBaixaFrequencia, Filtros = filtros };
        ...
        {
            if (__SessionWEB.BuscaRealizada.PaginaBusca == PaginaGestao.DadosAlunosBaixaFrequencia)
            {
