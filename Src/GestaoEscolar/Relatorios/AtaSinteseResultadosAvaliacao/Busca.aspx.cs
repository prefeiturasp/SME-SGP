...
namespace GestaoEscolar.Relatorios.AtaSinteseResultadosAvaliacao
{
    public partial class Busca : MotherPageLogado
    {
        ...
        {
            if (__SessionWEB.BuscaRealizada.PaginaBusca == PaginaGestao.AtaSinteseResultadosAvaliacao)
            {
        ...
        protected void SalvarBusca()
        {
            ...
            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.AtaSinteseResultadosAvaliacao, Filtros = filtros };
        }
