...
namespace GestaoEscolar.Relatorios.AulasSemPlanoAula
{
    public partial class Busca : MotherPageLogado
    {
        ...
        protected void SalvaBusca()
        {
            ...
            filtros.Add("tci_id", UCBuscaDocenteTurma.Tci_id.ToString());
            filtros.Add("tpc_id", UCCPeriodoCalendario.Valor[0].ToString());
            filtros.Add("cap_id", UCCPeriodoCalendario.Valor[1].ToString());

            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.AulasSemPlanoAula, Filtros = filtros };
        ...
        {
            if (__SessionWEB.BuscaRealizada.PaginaBusca == PaginaGestao.AulasSemPlanoAula)
            {
                ...
                __SessionWEB.BuscaRealizada.Filtros.TryGetValue("tci_id", out valor);
                UCBuscaDocenteTurma.Tci_id = Convert.ToInt32(valor);
                UCBuscaDocenteTurma.UCComboTipoCiclo_IndexChanged();
