<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Relatorios.AtaSinteseEnriquecimentoCurricular.Busca" %>
        ...
        <ContentTemplate>
            <fieldset id="fdsDocumentosEscola" runat="server" style="margin-left: 10px;">
                ...
                <div class="right area-botoes-bottom">
                    <asp:Button ID="btnGerar" runat="server" Text="<%$ Resources:Relatorios, AtaSinteseEnriquecimentoCurricular.Busca.btnGerarRel.Text %>" OnClick="btnGerar_Click" CausesValidation="true" />
                </div>
            </fieldset>
        </ContentTemplate>
    </asp:UpdatePanel>
