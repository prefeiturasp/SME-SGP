<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Relatorios.AtaFinalResultadosEnriquecimentoCurricular.Busca" %>
        ...
        <ContentTemplate>
            <div>
                <fieldset id="fdsPesquisa" runat="server" style="margin-left: 10px;">
                    <legend>Ata final de resultados e de enriquecimento curricular</legend>
                    ...
                    <div id="_divPesquisa" class="divPesquisa" runat="server">
                        ...
                        <uc2:UCComboCursoCurriculo ID="UCComboCursoCurriculo1" MostrarMensagemSelecione="true"
                            runat="server" ValidationGroup="Resultados" Obrigatorio="true" />
                    ...
                    <div class="right">
                        <asp:Button ID="btnGerarRel" runat="server" Text="<%$ Resources:Relatorios, AtaFinalResultadosEnriquecimentoCurricular.Busca.btnGerarRel.Text %>" OnClick="btnGerarRel_Click"
