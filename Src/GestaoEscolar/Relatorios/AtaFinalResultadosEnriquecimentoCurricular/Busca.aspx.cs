namespace GestaoEscolar.Relatorios.AtaFinalResultadosEnriquecimentoCurricular
{
    using System;
    ...
    public partial class Busca : MotherPageLogado
    {
        ...
        {
            if (__SessionWEB.BuscaRealizada.PaginaBusca == PaginaGestao.AtaFinalResultadosEnriquecimentoCurricular)
            {
        ...
        private void SalvarBusca()
        {
            ...
            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.AtaFinalResultadosEnriquecimentoCurricular, Filtros = filtros };
        }
        #endregion Métodos
    }
}