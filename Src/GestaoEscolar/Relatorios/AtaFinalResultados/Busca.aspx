<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Relatorios.AtaFinalResultados.Busca" %>
        ...
        <ContentTemplate>
            <div>
                <fieldset id="fdsPesquisa" runat="server" style="margin-left: 10px;">
                    <legend>Ata final de resultados</legend>
                    ...
                    <div class="right area-botoes-bottom">
                        <asp:Button ID="btnGerarRel" runat="server" Text="<%$ Resources:Relatorios, AtaFinalResultado.Busca.btnGerarRel.Text %>" OnClick="btnGerarRel_Click"
