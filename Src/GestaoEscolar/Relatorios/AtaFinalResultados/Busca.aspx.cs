...
namespace GestaoEscolar.Relatorios.AtaFinalResultados
{
    public partial class Busca : MotherPageLogado
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (!__SessionWEB.__UsuarioWEB.GrupoPermissao.grp_consultar)
                    {
                        ...
                        lblMessage.Text = UtilBO.GetErroMessage(GetGlobalResourceObject("Relatorios", "AtaFinalResultado.Busca.lblMessage.ErroPermissao").ToString(), UtilBO.TipoMensagem.Alerta);
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    lblMessage.Text = UtilBO.GetErroMessage(GetGlobalResourceObject("Relatorios", "AtaFinalResultado.Busca.lblMessage.ErroCarregarSistema").ToString(), UtilBO.TipoMensagem.Erro);
                }
        ...
        protected void btnGerarRel_Click(object sender, EventArgs e)
        {
            ...
            {
                ApplicationWEB._GravaErro(ex);
                lblMessage.Text = UtilBO.GetErroMessage(GetGlobalResourceObject("Relatorios", "AtaFinalResultado.Busca.lblMessage.ErroGerarAta").ToString(), UtilBO.TipoMensagem.Erro);
            }
        }
        ...
        {
            if (__SessionWEB.BuscaRealizada.PaginaBusca == PaginaGestao.AtaFinalResultado)
            {
        ...
        private void GerarRel()
        {
            ...
            string report = ((int)MSTech.GestaoEscolar.BLL.ReportNameGestaoAcademica.AtaResultadoFinal).ToString();
        ...
        private void SalvarBusca()
        {
            ...
            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.AtaFinalResultado, Filtros = filtros };
        }
