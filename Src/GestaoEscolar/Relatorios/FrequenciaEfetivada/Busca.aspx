<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Relatorios.FrequenciaEfetivada.Busca" %>
...
<asp:UpdatePanel ID="updMessage" runat="server">
    ...
    <asp:UpdatePanel ID="updFiltros" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset id="fdsRelatorio" runat="server" style="margin-left: 10px;">
