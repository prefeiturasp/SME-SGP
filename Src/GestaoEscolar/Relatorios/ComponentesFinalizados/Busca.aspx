<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Busca.aspx.cs" Inherits="GestaoEscolar.Relatorios.ComponentesFinalizados.Busca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="updMensagens" runat="server">
        <ContentTemplate>
            ...
            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="ValidarTurmasComponentesFinalizados" />
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:Panel ID="pnlBusca" runat="server" GroupingText="">
        <div class="area-form">
            ...
            <uc3:UCCPeriodoCalendario ID="UCCPeriodoCalendario1" runat="server" MostrarMensagemSelecione="true" TrazerComboCarregado="true" PermiteEditar="false"
                Obrigatorio="true" ValidationGroup="ValidarTurmasComponentesFinalizados" MostrarOpcaoFinal="true" SelecionaPeriodoAtualAoCarregar="true" />
        </div>
        <div class="right area-botoes-bottom">
            <asp:Button ID="btnGerar" runat="server" Text="<%$ Resources:Relatorios, ComponentesFinalizados.Busca.btnGerarRel.Text %>" ValidationGroup="ValidarTurmasComponentesFinalizados" OnClick="btnGerar_Click"/>
        </div>
    </asp:Panel>
</asp:Content>
