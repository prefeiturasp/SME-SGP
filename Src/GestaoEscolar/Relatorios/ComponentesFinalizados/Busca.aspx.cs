...
namespace GestaoEscolar.Relatorios.ComponentesFinalizados
{
    public partial class Busca : MotherPageLogado
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                pnlBusca.GroupingText = GestaoEscolarUtilBO.BuscaNomeModulo("~/Relatorios/ComponentesFinalizados/Busca.aspx", "Acompanhamento do registro de fechamento bimestral", __SessionWEB.__UsuarioWEB.Grupo.gru_id);
                InicializaCombos();
                CarregarBusca();
        }
        ...
        protected void SalvaBusca()
        {
            ...
            __SessionWEB.BuscaRealizada = new BuscaGestao { PaginaBusca = PaginaGestao.Turmas_ComponentesFinalizados, Filtros = filtros };
