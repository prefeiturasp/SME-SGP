                ...
                <asp:UpdatePanel ID="updAulas" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gdvAulas" runat="server" AutoGenerateColumns="false" OnRowDataBound="gdvAulas_RowDataBound"
                            DataKeyNames="uni_id, esc_id, cal_id, tur_id, tud_id, tud_cargaHorariaSemanal, TurmaDisciplina, tud_tipo, tdt_posicao, tud_idRelacionada, cap_dataInicio, cap_dataFim, cap_descricao, escola, curso, turno, fav_fechamentoAutomatico"
