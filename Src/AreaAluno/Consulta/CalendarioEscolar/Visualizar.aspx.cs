...
public partial class Consulta_CalendarioAnual_Visualizar : MotherPageLogado
{
                ...
                if (dataValida)
                {
                        ...
                        && dataInicioEvento.Year == ((Calendar)e.Item.FindControl("calMesPeriodo")).VisibleDate.Year)
                    {
                        ...
                        dr["periodo"] = bool.Parse(row["evt_semAtividadeDiscente"].ToString()) ?
                            "<font color=" + CorPeriodosEventos + "><b>" + dataInicioEvento.Day + "</b></font>: " + row["evt_nome"] + "<br />" :
                            "<font color=" + CorPeriodosEventos + "><b>" + dataInicioEvento.Day + "</b></font>: " + row["evt_nome"] + "<br />";
                        dtEventos.Rows.Add(dr);
                    }
                    else
                    {
                            ...
                            && dataInicioEvento.Year == ((Calendar)e.Item.FindControl("calMesPeriodo")).VisibleDate.Year)
                        {
                            ...
                            dr["dia"] = dataInicioEvento.Day;
                            dr["periodo"] = bool.Parse(row["evt_semAtividadeDiscente"].ToString()) ?
                                "<font color=" + CorPeriodosEventos + "><b>" + dataInicioEvento.Day + "</b></font>: " + "Início " + row["evt_nome"] + "<br />" :
                                "<font color=" + CorPeriodosEventos + "><b>" + dataInicioEvento.Day + "</b></font>: " + "Início " + row["evt_nome"] + "<br />";
                            dtEventos.Rows.Add(dr);
                        }
                            ...
                            && dataFimEvento.Year == ((Calendar)e.Item.FindControl("calMesPeriodo")).VisibleDate.Year)
                        {
                            ...
                            dr["periodo"] = bool.Parse(row["evt_semAtividadeDiscente"].ToString()) ?
                                "<font color=" + CorPeriodosEventos + "><b>" + dataFimEvento.Day + "</b></font>: " + "Fim " + row["evt_nome"] + "<br />" :
                                "<font color=" + CorPeriodosEventos + "><b>" + dataFimEvento.Day + "</b></font>: " + "Fim " + row["evt_nome"] + "<br />";
                            dtEventos.Rows.Add(dr);
                        }
                    }
