...
namespace AreaAluno.WebControls.Sistemas
{
    /// <summary>
    ...
    public partial class UCSistemas : MotherUserControl
    {
        #region EVENTOS
        ...
        {
            if (!e.ExecutingSelectCount && __SessionWEB.__UsuarioWEB.Usuario != null)
            {
