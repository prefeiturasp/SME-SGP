<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCBoletimCompletoAluno.ascx.cs" Inherits="AreaAluno.WebControls.BoletimCompletoAluno.UCBoletimCompletoAluno" %>
