<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAlunoBoletimEscolar.ascx.cs" Inherits="AreaAluno.WebControls.AlunoBoletimEscolar.UCAlunoBoletimEscolar" %>

<asp:UpdatePanel ID="upnBoletim" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Label ID="lblMessage" runat="server" EnableViewState="false"></asp:Label>
        <div runat="server" id="divImprimirBoletim" class="right">
            <input id="btnImprimir" class="btn btnImprimir" type="button" style="color: #1683c6 !important;" value="Imprimir" onclick="window.print()" />
        </div>
                        ...
                        <td>
                            <div class="divDados">
                                <table class="tblBoletim tblBoletimDetalhes" width="100%" rules="none">
                                    <tbody>
                                        <tr>
                                            <th class="linhaConceitoGlobal" colspan="3"><strong><span>Boletim Escolar</span></strong>
                                            </th>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                ...
                                <table class="tblBoletim" rules="none">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 50px;" rowspan="2" class="nomePeriodo">Total de Ausências
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="trParecerConclusivo" runat="server" class='trDisciplina'>
                                            <td class="nota tdParecerConclusivo" colspan="20">
                                                <asp:Literal ID="lblParecerConclusivo" runat="server" Text="Parecer conclusivo: "></asp:Literal>
                                    ...
                                    <table class="tblBoletim" rules="none">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="nomePeriodo">Total Ausências
                                                </th>
