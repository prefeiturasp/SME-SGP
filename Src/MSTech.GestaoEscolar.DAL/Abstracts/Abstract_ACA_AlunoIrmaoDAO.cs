...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_AlunoIrmao
	/// </summary>
	public abstract class Abstract_ACA_AlunoIrmaoDAO : Abstract_DAL<ACA_AlunoIrmao>
	{
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_AlunoIrmao entity)
		{
			...
			Param.Size = 8;
			Param.Value = entity.alu_idIrmao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 1;
			Param.Value = entity.ali_situacao;
			qs.Parameters.Add(Param);
