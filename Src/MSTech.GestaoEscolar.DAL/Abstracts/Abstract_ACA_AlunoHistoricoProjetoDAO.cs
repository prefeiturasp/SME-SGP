...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_AlunoHistoricoProjeto.
	/// </summary>
	public abstract class Abstract_ACA_AlunoHistoricoProjetoDAO : Abstract_DAL<ACA_AlunoHistoricoProjeto>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_AlunoHistoricoProjeto entity)
		{
			...
			Param.ParameterName = "@ahp_nome";
			Param.Size = 150;
			Param.Value = entity.ahp_nome;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.Byte;
			Param.ParameterName = "@ahp_situacao";
			Param.Size = 1;
			Param.Value = entity.ahp_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@ahp_dataAlteracao";
			Param.Size = 16;
			Param.Value = entity.ahp_dataAlteracao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@ahp_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.ahp_dataCriacao;
			qs.Parameters.Add(Param);
