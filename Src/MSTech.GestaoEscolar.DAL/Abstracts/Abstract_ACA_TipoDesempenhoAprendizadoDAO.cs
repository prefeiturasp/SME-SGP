...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_TipoDesempenhoAprendizado.
	/// </summary>
	public abstract class AbstractACA_TipoDesempenhoAprendizadoDAO : Abstract_DAL<ACA_TipoDesempenhoAprendizado>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_TipoDesempenhoAprendizado entity)
		{
			...
			Param.Size = 1;
			Param.Value = entity.tda_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@tda_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.tda_dataCriacao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 16;
			Param.Value = entity.tda_dataAlteracao;
			qs.Parameters.Add(Param);
		...
		protected override bool ReceberAutoIncremento(QuerySelectStoredProcedure qs, ACA_TipoDesempenhoAprendizado entity)
		{
			if (entity != null & qs != null)
            {
			entity.tda_id = Convert.ToInt32(qs.Return.Rows[0][0]);
			return (entity.tda_id > 0);
			}
