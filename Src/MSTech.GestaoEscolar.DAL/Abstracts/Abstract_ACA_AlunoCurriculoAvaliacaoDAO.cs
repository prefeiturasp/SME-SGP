...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_AlunoCurriculoAvaliacao
	/// </summary>
	public abstract class Abstract_ACA_AlunoCurriculoAvaliacaoDAO : Abstract_DAL<ACA_AlunoCurriculoAvaliacao>
	{
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, ACA_AlunoCurriculoAvaliacao entity)
		{
		...
		/// </summary>
		/// <param name="qs">Objeto da Store Procedure</param>
		protected override bool ReceberAutoIncremento(QuerySelectStoredProcedure qs, ACA_AlunoCurriculoAvaliacao entity)
        {
            entity.ala_id = Convert.ToInt32(qs.Return.Rows[0][0]);
            return (entity.ala_id > 0);
		}		
	}
}
