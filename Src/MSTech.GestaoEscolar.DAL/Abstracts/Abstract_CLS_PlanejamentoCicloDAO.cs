...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_PlanejamentoCiclo.
	/// </summary>
	public abstract class Abstract_CLS_PlanejamentoCicloDAO : Abstract_DAL<CLS_PlanejamentoCiclo>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, CLS_PlanejamentoCiclo entity)
		{
			...
			Param.Size = 4;
			Param.Value = entity.plc_anoLetivo;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@plc_id";
			Param.Size = 4;
			Param.Value = entity.plc_id;
			qs.Parameters.Add(Param);
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CLS_PlanejamentoCiclo entity)
		{
			...
			Param.ParameterName = "@plc_planoCiclo";
			Param.Size = 2147483647;
			Param.Value = entity.plc_planoCiclo;
			qs.Parameters.Add(Param);
			...
			Param.Size = 1;
			Param.Value = entity.plc_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@plc_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.plc_dataCriacao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 16;
			Param.Value = entity.plc_dataAlteracao;
			qs.Parameters.Add(Param);
