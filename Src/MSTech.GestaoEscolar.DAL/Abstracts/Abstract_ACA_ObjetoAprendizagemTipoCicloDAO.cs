...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_ObjetoAprendizagemTipoCiclo.
	/// </summary>
	public abstract class Abstract_ACA_ObjetoAprendizagemTipoCicloDAO : Abstract_DAL<ACA_ObjetoAprendizagemTipoCiclo>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
