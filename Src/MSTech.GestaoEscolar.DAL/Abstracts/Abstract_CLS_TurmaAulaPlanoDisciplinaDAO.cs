...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_TurmaAulaPlanoDisciplina.
	/// </summary>
	public abstract class Abstract_CLS_TurmaAulaPlanoDisciplinaDAO : Abstract_DAL<CLS_TurmaAulaPlanoDisciplina>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
