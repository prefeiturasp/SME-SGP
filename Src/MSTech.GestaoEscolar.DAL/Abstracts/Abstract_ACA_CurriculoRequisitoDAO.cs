...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_CurriculoRequisito
	/// </summary>
	public abstract class Abstract_ACA_CurriculoRequisitoDAO : Abstract_DAL<ACA_CurriculoRequisito>
	{
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, ACA_CurriculoRequisito entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@dis_idRequisito";
			Param.Size = 4;
			Param.Value = entity.dis_idRequisito;
			qs.Parameters.Add(Param);
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_CurriculoRequisito entity)
		{
			...
			Param.ParameterName = "@crq_tipo";
			Param.Size = 1;
			Param.Value = entity.crq_tipo;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.Byte;
			Param.ParameterName = "@crq_situacao";
			Param.Size = 1;
			Param.Value = entity.crq_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@crq_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.crq_dataCriacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@crq_dataAlteracao";
			Param.Size = 16;
			Param.Value = entity.crq_dataAlteracao;
			qs.Parameters.Add(Param);
		...
		{
            entity.dis_idRequisito = Convert.ToInt32(qs.Return.Rows[0][0]);
            return (entity.dis_idRequisito > 0);
		}		
	}
}
