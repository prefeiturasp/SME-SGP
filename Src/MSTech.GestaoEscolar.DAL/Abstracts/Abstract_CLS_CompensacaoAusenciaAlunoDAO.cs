...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_CompensacaoAusenciaAluno.
	/// </summary>
	public abstract class AbstractCLS_CompensacaoAusenciaAlunoDAO : Abstract_DAL<CLS_CompensacaoAusenciaAluno>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
