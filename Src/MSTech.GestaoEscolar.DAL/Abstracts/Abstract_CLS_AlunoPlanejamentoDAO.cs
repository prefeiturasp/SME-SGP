...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_AlunoPlanejamento.
	/// </summary>
	public abstract class Abstract_CLS_AlunoPlanejamentoDAO : Abstract_DAL<CLS_AlunoPlanejamento>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, CLS_AlunoPlanejamento entity)
		{
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CLS_AlunoPlanejamento entity)
		{
			...
			Param.ParameterName = "@apl_planejamento";
			Param.Size = 2147483647;
				if(!string.IsNullOrEmpty(entity.apl_planejamento))
				{
					Param.Value = entity.apl_planejamento;
				}
				else
				{
			...
			Param.ParameterName = "@apl_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.apl_dataCriacao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 16;
			Param.Value = entity.apl_dataAlteracao;
			qs.Parameters.Add(Param);
