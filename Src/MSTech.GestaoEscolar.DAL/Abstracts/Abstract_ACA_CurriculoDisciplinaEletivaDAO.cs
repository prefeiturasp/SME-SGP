...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_CurriculoDisciplinaEletiva
	/// </summary>
	public abstract class Abstract_ACA_CurriculoDisciplinaEletivaDAO : Abstract_DAL<ACA_CurriculoDisciplinaEletiva>
	{
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, ACA_CurriculoDisciplinaEletiva entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@cde_id";
			Param.Size = 4;
			Param.Value = entity.cde_id;
			qs.Parameters.Add(Param);
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_CurriculoDisciplinaEletiva entity)
		{
			...
			Param.ParameterName = "@cde_nome";
			Param.Size = 200;
			if( !string.IsNullOrEmpty(entity.cde_nome) )
				Param.Value = entity.cde_nome;
			else
		...
		{
            entity.cde_id = Convert.ToInt32(qs.Return.Rows[0][0]);
            return (entity.cde_id > 0);
		}		
	}
}
