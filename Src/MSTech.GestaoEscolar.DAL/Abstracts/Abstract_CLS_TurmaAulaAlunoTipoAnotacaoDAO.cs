...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_TurmaAulaAlunoTipoAnotacao.
	/// </summary>
	public abstract class Abstract_CLS_TurmaAulaAlunoTipoAnotacaoDAO : Abstract_DAL<CLS_TurmaAulaAlunoTipoAnotacao>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
