...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_TipoJustificativaFalta
	/// </summary>
	public abstract class Abstract_ACA_TipoJustificativaFaltaDAO : Abstract_DAL<ACA_TipoJustificativaFalta>
	{
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_TipoJustificativaFalta entity)
		{
			...
			Param.Size = 100;
			Param.Value = entity.tjf_nome;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.AnsiString;
			Param.ParameterName = "@tjf_codigo";
			Param.Size = 20;
			if( !string.IsNullOrEmpty(entity.tjf_codigo) )
				Param.Value = entity.tjf_codigo;
			else
			...
			Param.ParameterName = "@tjf_abonaFalta";
			Param.Size = 1;
				Param.Value = entity.tjf_abonaFalta;
			qs.Parameters.Add(Param);
			...
			Param.Size = 1;
			Param.Value = entity.tjf_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@tjf_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.tjf_dataCriacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@tjf_dataAlteracao";
			Param.Size = 16;
			Param.Value = entity.tjf_dataAlteracao;
			qs.Parameters.Add(Param);
		...
		{
			entity.tjf_id = Convert.ToInt32(qs.Return.Rows[0][0]);
			return (entity.tjf_id > 0);
		}		
	}
}
