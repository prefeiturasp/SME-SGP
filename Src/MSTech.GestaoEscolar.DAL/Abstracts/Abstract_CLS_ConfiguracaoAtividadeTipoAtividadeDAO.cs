...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_ConfiguracaoAtividadeTipoAtividade.
	/// </summary>
	public abstract class Abstract_CLS_ConfiguracaoAtividadeTipoAtividadeDAO : Abstract_DAL<CLS_ConfiguracaoAtividadeTipoAtividade>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
