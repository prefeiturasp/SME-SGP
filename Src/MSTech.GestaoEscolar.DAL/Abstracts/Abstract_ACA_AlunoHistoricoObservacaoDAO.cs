...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de ACA_AlunoHistoricoObservacao
	/// </summary>
	public abstract class Abstract_ACA_AlunoHistoricoObservacaoDAO : Abstract_DAL<ACA_AlunoHistoricoObservacao>
	{
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_AlunoHistoricoObservacao entity)
		{
			...
			Param.Size = 1;
			Param.Value = entity.aho_tipo;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@aho_numeroObs";
			Param.Size = 4;
			if( entity.aho_numeroObs > 0  )
				Param.Value = entity.aho_numeroObs;
			else
			...
			Param.ParameterName = "@aho_observacao";
			Param.Size = 2147483647;
			Param.Value = entity.aho_observacao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 1;
			Param.Value = entity.aho_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@aho_dataCriacao";
			Param.Size = 16;
			Param.Value = entity.aho_dataCriacao;
			qs.Parameters.Add(Param);
			...
			Param.Size = 16;
			Param.Value = entity.aho_dataAlteracao;
			qs.Parameters.Add(Param);
		...
		{
            entity.aho_id = Convert.ToInt32(qs.Return.Rows[0][0]);
            return (entity.aho_id > 0);
		}		
	}
}