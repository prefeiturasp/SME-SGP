...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de TUR_TurmaDisciplinaCalendario
	/// </summary>
	public abstract class Abstract_TUR_TurmaDisciplinaCalendarioDAO : Abstract_DAL<TUR_TurmaDisciplinaCalendario>
	{
