...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de REL_GraficoAtendimento_FiltrosPersonalizados.
	/// </summary>
	public abstract class Abstract_REL_GraficoAtendimento_FiltrosPersonalizadosDAO : Abstract_DAL<REL_GraficoAtendimento_FiltrosPersonalizados>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
