...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_AlunoFrequenciaExterna.
	/// </summary>
	public abstract class Abstract_CLS_AlunoFrequenciaExternaDAO : Abstract_DAL<CLS_AlunoFrequenciaExterna>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, CLS_AlunoFrequenciaExterna entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@afx_id";
			Param.Size = 4;
			Param.Value = entity.afx_id;
			qs.Parameters.Add(Param);
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CLS_AlunoFrequenciaExterna entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@afx_qtdAulas";
			Param.Size = 4;
				if(entity.afx_qtdAulas > 0 )
				{
					Param.Value = entity.afx_qtdAulas;
				}
				else
				{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@afx_qtdFaltas";
			Param.Size = 4;
				if(entity.afx_qtdFaltas > 0 )
				{
					Param.Value = entity.afx_qtdFaltas;
				}
				else
				{
					Param.Value = DBNull.Value;
			...
			Param.Size = 1;
			Param.Value = entity.afx_situacao;
			qs.Parameters.Add(Param);
			...
			Param.Value = entity.afx_dataAlteracao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@afx_dataCriacao";

			Param.Value = entity.afx_dataCriacao;
			qs.Parameters.Add(Param);
