...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_RelatorioAtendimentoQuestionario.
	/// </summary>
	public abstract class Abstract_CLS_RelatorioAtendimentoQuestionarioDAO : Abstract_DAL<CLS_RelatorioAtendimentoQuestionario>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CLS_RelatorioAtendimentoQuestionario entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@raq_ordem";
			Param.Size = 4;
			Param.Value = entity.raq_ordem;
			qs.Parameters.Add(Param);
			...
			Param.Size = 1;
			Param.Value = entity.raq_situacao;
			qs.Parameters.Add(Param);

			Param = qs.NewParameter();
			Param.DbType = DbType.DateTime;
			Param.ParameterName = "@raq_dataCriacao";

			Param.Value = entity.raq_dataCriacao;
			qs.Parameters.Add(Param);
			...
			Param.Value = entity.raq_dataAlteracao;
			qs.Parameters.Add(Param);
		...
		protected override bool ReceberAutoIncremento(QuerySelectStoredProcedure qs, CLS_RelatorioAtendimentoQuestionario entity)
		{
			if (entity != null & qs != null)
            {
			entity.raq_id = Convert.ToInt32(qs.Return.Rows[0][0]);
			return (entity.raq_id > 0);
			}
