...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CFG_HistoricoPedagogico.
	/// </summary>
	public abstract class Abstract_CFG_HistoricoPedagogicoDAO : Abstract_DAL<CFG_HistoricoPedagogico>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CFG_HistoricoPedagogico entity)
		{
			...
			Param = qs.NewParameter();
			Param.DbType = DbType.Int32;
			Param.ParameterName = "@cur_idFundamentalPadrao";
			Param.Size = 4;
			Param.Value = entity.cur_idFundamentalPadrao;
			qs.Parameters.Add(Param);

            Param = qs.NewParameter();
            Param.DbType = DbType.Int32;
            Param.ParameterName = "@chp_qtdMaxProjeto";
            Param.Size = 4;
            Param.Value = entity.chp_qtdMaxProjeto;
            qs.Parameters.Add(Param);
