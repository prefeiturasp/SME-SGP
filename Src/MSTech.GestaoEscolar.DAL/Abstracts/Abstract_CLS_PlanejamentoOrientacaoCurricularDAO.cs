...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_PlanejamentoOrientacaoCurricular.
	/// </summary>
	public abstract class Abstract_CLS_PlanejamentoOrientacaoCurricularDAO : Abstract_DAL<CLS_PlanejamentoOrientacaoCurricular>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, CLS_PlanejamentoOrientacaoCurricular entity)
		{
		...
		/// <param name="qs">Objeto da Store Procedure.</param>
        /// <param name="entity">Entidade com os dados para preenchimento dos parametros.</param>
		protected override void ParamAlterar(QueryStoredProcedure qs, CLS_PlanejamentoOrientacaoCurricular entity)
		{
			if (entity != null & qs != null)
            {
			Param = qs.NewParameter();
		...
		/// <param name="qs">Objeto da Store Procedure.</param>
        /// <param name="entity">Entidade com os dados para preenchimento dos parametros.</param>
		protected override void ParamDeletar(QueryStoredProcedure qs, CLS_PlanejamentoOrientacaoCurricular entity)
		{
			if (entity != null & qs != null)
            {
			Param = qs.NewParameter();
