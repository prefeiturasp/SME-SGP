...
namespace MSTech.GestaoEscolar.DAL.Abstracts
{
	...
	/// <summary>
	/// Classe abstrata de CLS_AlunoTurmaDisciplinaOrientacaoCurricular.
	/// </summary>
	public abstract class Abstract_CLS_AlunoTurmaDisciplinaOrientacaoCurricularDAO : Abstract_DAL<CLS_AlunoTurmaDisciplinaOrientacaoCurricular>
	{
        /// <summary>
		/// ConnectionString.
		/// </summary>
		...
		protected override void ParamCarregar(QuerySelectStoredProcedure qs, CLS_AlunoTurmaDisciplinaOrientacaoCurricular entity)
		{
		...
		protected override void ParamInserir(QuerySelectStoredProcedure qs, CLS_AlunoTurmaDisciplinaOrientacaoCurricular entity)
		{
			...
			Param.Size = 16;
			Param.Value = entity.aha_dataCriacao;
			qs.Parameters.Add(Param);
