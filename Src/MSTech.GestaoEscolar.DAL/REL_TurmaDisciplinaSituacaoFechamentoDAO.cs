...
namespace MSTech.GestaoEscolar.DAL
{
	...
	public class REL_TurmaDisciplinaSituacaoFechamentoDAO : Abstract_REL_TurmaDisciplinaSituacaoFechamentoDAO
    {
        ...
        /// <param name="tev_EfetivacaoNotas">Tipo de evento de efetivação de notas.</param>
        /// <returns></returns>
        public DataTable SelecionaPendencias(DataTable dtTurmaDisciplina, int tev_EfetivacaoNotas)
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_REL_TurmaDisciplinaSituacaoFechamento_SelecionaPendencias", _Banco);
