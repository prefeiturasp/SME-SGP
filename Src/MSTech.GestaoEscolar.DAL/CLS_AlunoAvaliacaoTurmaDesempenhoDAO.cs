...
namespace MSTech.GestaoEscolar.DAL
{
	...
	/// Description: .
	/// </summary>
	public class CLS_AlunoAvaliacaoTurmaDesempenhoDAO : Abstract_CLS_AlunoAvaliacaoTurmaDesempenhoDAO
    {
        #region Consultas
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_CLS_AlunoAvaliacaoTurmaDesempenho_SelecionaPorMatriculaTurma", _Banco);
