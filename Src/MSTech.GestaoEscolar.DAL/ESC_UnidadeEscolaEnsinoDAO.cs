...
namespace MSTech.GestaoEscolar.DAL
{
	...
	/// 
	/// </summary>
	public class ESC_UnidadeEscolaEnsinoDAO : Abstract_ESC_UnidadeEscolaEnsinoDAO
	{
        /// <summary>
        ...
        {            
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ESC_UnidadeEscolaEnsino_SelectBy_esc_id_uni_id", _Banco);
            try
            {
                #region PARAMETROS
        ...
        protected override void ParamInserir(QuerySelectStoredProcedure qs, ESC_UnidadeEscolaEnsino entity)
        {
            ...
            qs.Parameters["@uee_dataCriacao"].Value = DateTime.Now;
            qs.Parameters["@uee_dataAlteracao"].Value = DateTime.Now;
        }
        ...
        protected override void ParamAlterar(QueryStoredProcedure qs, ESC_UnidadeEscolaEnsino entity)
        {
            ...
            qs.Parameters.RemoveAt("@uee_dataCriacao");
            qs.Parameters["@uee_dataAlteracao"].Value = DateTime.Now;
        }
        ...
        protected override bool Alterar(ESC_UnidadeEscolaEnsino entity)
        {
            __STP_UPDATE = "NEW_ESC_UnidadeEscolaEnsino_UPDATE";
        ...
        /// <returns>true = sucesso | false = fracasso</returns>        
        public override bool Delete(ESC_UnidadeEscolaEnsino entity)
        {
            __STP_DELETE = "NEW_ESC_UnidadeEscolaEnsino_Update_Situacao";
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //protected override bool Inserir(ESC_UnidadeEscolaEnsino entity)
        //{
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //public override bool Carregar(ESC_UnidadeEscolaEnsino entity)
        //{
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //public override bool Salvar(ESC_UnidadeEscolaEnsino entity)
        //{
        ...
        //public override IList<ESC_UnidadeEscolaEnsino> Select()
        //{
        //    return base.Select();
        //}
        ///// <summary>
        ...
        //public override IList<ESC_UnidadeEscolaEnsino> Select_Paginado(int currentPage, int pageSize, out int totalRecord)
        //{
        ...
        //public override ESC_UnidadeEscolaEnsino DataRowToEntity(DataRow dr, ESC_UnidadeEscolaEnsino entity)
        //{
        ...
        ///// <returns>Entidade preenchida</returns>
        //public override ESC_UnidadeEscolaEnsino DataRowToEntity(DataRow dr, ESC_UnidadeEscolaEnsino entity, bool limparEntity)
        //{
