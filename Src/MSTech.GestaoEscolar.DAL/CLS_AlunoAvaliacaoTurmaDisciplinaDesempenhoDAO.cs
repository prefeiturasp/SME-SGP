...
namespace MSTech.GestaoEscolar.DAL
{
	...
	/// Description: .
	/// </summary>
	public class CLS_AlunoAvaliacaoTurmaDisciplinaDesempenhoDAO : Abstract_CLS_AlunoAvaliacaoTurmaDisciplinaDesempenhoDAO
    {
        #region Consultas
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_CLS_AlunoAvaliacaoTurmaDisciplinaDesempenho_SelecionaPorMatriculaTurmaDisciplina", _Banco);
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_CLS_AlunoAvaliacaoTurmaDisciplinaDesempenho_SelectBy_AluId_CurId_CrrId_CrpId", _Banco);
