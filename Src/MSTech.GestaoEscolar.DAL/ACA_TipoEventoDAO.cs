...
{
	public class ACA_TipoEventoDAO : Abstract_ACA_TipoEventoDAO
	{
        /// <summary>
        ...
        {            
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_TipoEvento_SelectBy_Pesquisa", _Banco);
            try
            {
                #region PARAMETROS
        ...
        /// <summary>
        /// Retorna os tipos de nível de ensino não excluídos logicamente que podem ter 
        /// limites para cadastro de eventos
        /// </summary>                
        public DataTable SelecionaComLiberacao
        (
            Guid gru_id
        )
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_TipoEvento_Select_ComLiberacao", _Banco);
            try
            {
                #region PARAMETROS
        ...
        /// </summary>
        public DataTable SelecionaTodosRelacionados()
        {            
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_TipoEvento_Select_Relacionados", _Banco);
            try
            {
                qs.Execute();
        ...
        /// </summary>
        public DataTable SelecionaTodosNaoRelacionados()
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_TipoEvento_Select_NaoRelacionados", _Banco);
            try
            {
                qs.Execute();
        ...
        /// </summary>
        /// <param name="chavesEventos">Todas as chaves de Tipos de Eventos a serem retornados, entre virgulas</param>
        /// <returns></returns>
        public DataTable SelectBy_EventosEfetivacao(string chavesEventos)
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_TipoEvento_SelectBy_Efetivacao", _Banco);
            try
            {
                #region PARAMETROS
                ...
                Param.ParameterName = "@chaves";
                Param.Size = 20;
                Param.Value = chavesEventos;
                qs.Parameters.Add(Param);
        ...
        protected override void ParamInserir(QuerySelectStoredProcedure qs, ACA_TipoEvento entity)
        {
            ...
            qs.Parameters["@tev_dataCriacao"].Value = DateTime.Now;
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //protected override bool Inserir(ACA_TipoEvento entity)
        //{
        //}
        ///// <summary>
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //public override bool Carregar(ACA_TipoEvento entity)
        //{
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        ///// public override bool Salvar(ACA_TipoEvento entity)
        ///// {
        ...
        //public override IList<ACA_TipoEvento> Select()
        //{
        //    return base.Select();
        //}
        ///// <summary>
        ...
        //public override IList<ACA_TipoEvento> Select_Paginado(int currentPage, int pageSize, out int totalRecord)
        //{
        ...
        //public override ACA_TipoEvento DataRowToEntity(DataRow dr, ACA_TipoEvento entity)
        //{
        ...
        ///// <returns>Entidade preenchida</returns>
        //public override ACA_TipoEvento DataRowToEntity(DataRow dr, ACA_TipoEvento entity, bool limparEntity)
        //{
