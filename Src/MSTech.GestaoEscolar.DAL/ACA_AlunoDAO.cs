...
namespace MSTech.GestaoEscolar.DAL
{
    ...
    public class ACA_AlunoDAO : Abstract_ACA_AlunoDAO
    {
        ...
        /// <param name="totalRecords"></param>
        /// <returns></returns>
        public DataTable BuscaAlunosRelatoriosAEEPorDocente(Guid ent_id, long doc_id, bool MostraCodigoEscola, bool documentoOficial, out int totalRecords)
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_Aluno_BuscaAlunosRelatoriosAEEPorDocente", _Banco);
        ...
        /// <param name="buscaMatriculaIgual"></param>
        /// <param name="MostraCodigoEscola"></param>
        /// <param name="documentoOficial"></param>
        /// <param name="totalRecords"></param>
        /// <returns></returns>
        public DataTable BuscaAlunosRelatoriosAEE
        (
            int cal_id
            , int esc_id
            , int uni_id
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_Aluno_BuscaAlunosRelatoriosAEE", _Banco);
            try
            {
                #region PARAMETROS
        ...
        public DataTable BuscaAlunosRelatorioGeralAtendimento
        (
            int cal_id
            , int esc_id
            , int uni_id
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ACA_Aluno_BuscaAlunosRelatorioGeralAtendimento", _Banco);
            try
            {
                #region PARAMETROS
