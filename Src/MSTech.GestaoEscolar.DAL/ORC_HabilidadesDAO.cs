...
{	
	...
	/// 
	/// </summary>
	public class ORC_HabilidadesDAO : Abstract_ORC_HabilidadesDAO
    {
        #region Métodos
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ORC_Habilidades_SelectBy_Conteudo", _Banco);
        ...
        /// <summary>
        /// Verifica se existe a habilidade com a descrição passada no mesmo objetivo
        /// e conteúdo e com o hbl_id diferente do passado.
        /// </summary>                
        /// <param name="obj_id">Id do objetivo</param>
        /// <param name="ctd_id">Id do conteúdo.</param>
        /// <param name="hbl_descricao">Descrição da habilidade.</param>
        public bool SelectBy_Nome_Objetivo_Conteudo
        (
            int obj_id
            , int ctd_id
            , int hbl_id
        ...
        {
            QuerySelectStoredProcedure qs = new QuerySelectStoredProcedure("NEW_ORC_Habilidades_SelectBy_Nome_Conteudo_Objetivo", _Banco);
            try
            {
                #region PARAMETROS
        ...
        protected override void ParamInserir(QuerySelectStoredProcedure qs, ORC_Habilidades entity)
        {
            ...
            qs.Parameters["@hbl_dataCriacao"].Value = DateTime.Now;
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //protected override bool Inserir(ORC_Habilidades entity)
        //{
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //public override bool Carregar(ORC_Habilidades entity)
        //{
        ...
        ///// <returns>True - Operacao bem sucedida</returns>
        //public override bool Salvar(ORC_Habilidades entity)
        //{
        ...
        //public override IList<ORC_Habilidades> Select()
        //{
        //    return base.Select();
        //}
        ///// <summary>
        ...
        //public override IList<ORC_Habilidades> Select_Paginado(int currentPage, int pageSize, out int totalRecord)
        //{
        ...
        //public override ORC_Habilidades DataRowToEntity(DataRow dr, ORC_Habilidades entity)
        //{
        ...
        ///// <returns>Entidade preenchida</returns>
        //public override ORC_Habilidades DataRowToEntity(DataRow dr, ORC_Habilidades entity, bool limparEntity)
        //{
