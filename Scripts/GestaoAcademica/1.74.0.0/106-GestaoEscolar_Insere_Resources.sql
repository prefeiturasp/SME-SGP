...
SET XACT_ABORT ON   
	...
	*/
	...
	EXEC MS_InsereResource 
        @rcr_chave = 'RelatorioRecuperacaoParalela.Cadastro.MensagemSucessoExcluir' 
        , @rcr_NomeResource = 'Classe'
        , @rcr_cultura = 'pt-BR'
        , @rcr_codigo = 0 
        , @rcr_valorPadrao = 'Lançamento de anotação excluído com sucesso.'

	EXEC MS_InsereResource 
        @rcr_chave = 'RelatorioRecuperacaoParalela.Cadastro.grvLancamentos.ColunaDescricao' 
        , @rcr_NomeResource = 'Classe'
        , @rcr_cultura = 'pt-BR'
        , @rcr_codigo = 0 
	...
	EXEC MS_InsereResource 
        @rcr_chave = 'RelatorioRecuperacaoParalela.Cadastro.lblDisciplina.Text' 
        , @rcr_NomeResource = 'Classe'
        , @rcr_cultura = 'pt-BR'
        , @rcr_codigo = 0 
        , @rcr_valorPadrao = 'Turma - Componente curricular'

	EXEC MS_InsereResource 
        @rcr_chave = 'RelatorioAtendimento.Cadastro.gvCargo.HeaderCodigo' 
        , @rcr_NomeResource = 'Configuracao'
        , @rcr_cultura = 'pt-BR'
        , @rcr_codigo = 0 
        , @rcr_valorPadrao = 'Código do cargo'

	EXEC MS_InsereResource 
        @rcr_chave = 'RelatorioAtendimento.Cadastro.gvCargo.HeaderTipoVinculo' 
        , @rcr_NomeResource = 'Configuracao'
        , @rcr_cultura = 'pt-BR'
        , @rcr_codigo = 0 
