...
SET XACT_ABORT ON
	...
	*/
	...
	EXEC MS_InsereRelatorio
		@rlt_id = 324 -- ID do relatório. (Obrigatório, igual ao enumerador do sistema)
		,@rlt_nome = 'QuantitativoSugestoes' -- Nome do relatorio. (Obrigatório, igual a descricção do enumerador do sistema)
