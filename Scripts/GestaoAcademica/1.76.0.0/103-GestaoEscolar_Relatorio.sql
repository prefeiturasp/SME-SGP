...
SET XACT_ABORT ON
	...
	*/
	...
	EXEC MS_InsereRelatorio
		@rlt_id = 328 -- ID do relatório. (Obrigatório, igual ao enumerador do sistema)
		,@rlt_nome = 'LogNotificacoes' -- Nome do relatorio. (Obrigatório, igual a descricção do enumerador do sistema)
